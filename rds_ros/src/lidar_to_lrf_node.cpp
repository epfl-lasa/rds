...
void LidarToLRFNode::velodyneMessageCallback(const velodyne_msgs::VelodyneScan::ConstPtr& v_scan)
{
...
{
	ros::init(argc, argv, "rds_ros_lidar_to_lrf_node");
	ros::NodeHandle n;
	LidarToLRFNode lidar_to_lrf_node(&n);
	return 0;
}
