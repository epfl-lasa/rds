...
folder_path = "./jul_16_door_orca_2/"
picture_export_prefix = "./pictures/jul_16_door_orca_2_"
...
capsule.plot_at_pose(x_of_t(t_d_min_2), y_of_t(t_d_min_2), phi_of_t(t_d_min_2), ax, orca=True)
