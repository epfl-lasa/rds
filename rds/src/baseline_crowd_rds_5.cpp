...
const VWDiamond vw_diamond_limits_generous(-0.75, 1.5, 4.124,
	0.2);
...
int main()
{
	...
	const unsigned int samples_offset = 6;
	TimeWindow time_window(100000.0, -100000.0); // to be updated
	for (unsigned int sample_index = samples_offset; sample_index != (n_samples + samples_offset); ++sample_index)
	{
